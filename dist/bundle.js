...
(() => {
    ...
    "node_modules/.pnpm/jquery@3.7.1/node_modules/jquery/dist/jquery.js"(exports, module) {
      (function(global, factory) {
        ...
        function buildFragment(elems, context, scripts, selection, ignored) {
          var elem, tmp, tag, wrap, attached, j, fragment2 = context.createDocumentFragment(), nodes = [], i = 0, l = elems.length;
          for (; i < l; i++) {
            elem = elems[i];
            if (elem || elem === 0) {
        ...
        function domManip(collection, args, callback, ignored) {
          args = flat(args);
          var fragment2, first, scripts, hasScripts, node, doc, i = 0, l = collection.length, iNoClone = l - 1, value = args[0], valueIsFunction = isFunction(value);
          ...
          if (l) {
            ...
            if (first || ignored) {
              scripts = jQuery.map(getAll(fragment2, "script"), disableScript);
  ...
  var toDo = () => {
    ...
    <footer id="footer" class="footer">
      <div class="footer__mailto">
        ...
        <a href="mailto:14bryansaenz@gmail.com">Env\xEDame un correo</a>
      </div>
      <div class="footer__info">
        <p>B14S</p>
        <p>
          Aprendo y creo todos los d\xEDas.
        </p>
        <ul>
          <li>
        ...
        <p>Desarrollado por Bryan Saenz \xA9(2025)</p>
      </div>
    </footer>`;
    fragment.appendChild(section);
    return fragment;
  ...
  // src/js/main.js
  var IDBRequest = indexedDB.open("Users", 1);
  var db;
  var dbDatos;
  IDBRequest.addEventListener("upgradeneeded", (e) => {
    ...
    if (target) {
      ...
      if (!db2.objectStoreNames.contains("Users")) {
        db2.createObjectStore("Users", { autoIncrement: true });
      }
    }
  });
  ...
  function openDBDatos() {
    return new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = (e) => {
        ...
        if (!db2.objectStoreNames.contains("Clientes")) {
          db2.createObjectStore("Clientes", { autoIncrement: true });
        }
      };
      request.onsuccess = (e) => {
  ...
  var cargarClient = () => {
    obtenerClient().addEventListener("success", (e) => {
      ...
      $tbody.innerHTML = "";
      $tbody.append(fragment2);
    });
  };
  var searchClient = (name) => {
    obtenerClient().addEventListener("success", (e) => {
      const clients = e.target.result;
      const fragment2 = document.createDocumentFragment();
      clients.filter(
        (client) => client.name.toLowerCase().includes(name.toLowerCase())
      ).sort((a, b) => a.name.localeCompare(b.name)).forEach((client) => {
        const row = document.createElement("tr");
        row.innerHTML = `
          <td scope="row">${client.id}</td>
          <td>${client.name}</td>
      ...
      (0, import_jquery.default)("#tbody").innerHTML = "";
      if (fragment2.children.length > 0) {
        (0, import_jquery.default)("#tbody").append(fragment2);
      } else {
        (0, import_jquery.default)("#tbody").innerHTML = '<tr><td colspan="6">No hay clientes disponibles</td></tr>';
      }
    });
  };
  (0, import_jquery.default)(async function() {
    (0, import_jquery.default)("#app").append(login());
    dbDatos = await openDBDatos();
    cargarClient();
    (0, import_jquery.default)("#app").on("click", "#btnLogin", () => {
      (0, import_jquery.default)("#app").empty();
      (0, import_jquery.default)("#app").append(login());
    });
    (0, import_jquery.default)("#app").on("click", "#btnRegister", () => {
      (0, import_jquery.default)("#app").empty();
      (0, import_jquery.default)("#app").append(register());
    });
    (0, import_jquery.default)("#app").on("submit", "#formLogin", (e) => {
      e.preventDefault();
      const email = (0, import_jquery.default)("#inputEmail").val();
      const pass = (0, import_jquery.default)("#inputPass").val();
      if (!email || !pass) {
      ...
      request.addEventListener("success", (e2) => {
        ...
        if (cursor) {
          ...
          if (value.email === email && value.pass === pass) {
            (0, import_jquery.default)("#app").empty();
            (0, import_jquery.default)("#app").append(toDo());
            return;
          }
          cursor.continue();
        } else {
      ...
      request.addEventListener("error", (e2) => {
        const target = e2.target;
        throw new Error("Error al abrir la base de datos", target.error);
      });
      request.addEventListener("complete", (e2) => {
        const target = e2.target;
        throw new Error("Error al abrir la base de datos", target.error);
      });
    });
    (0, import_jquery.default)("#app").on("submit", "#formRegister", (e) => {
      e.preventDefault();
      const usuario = {
        Username: (0, import_jquery.default)("#inputText").val(),
        email: (0, import_jquery.default)("#inputEmail").val(),
        pass: (0, import_jquery.default)("#inputPass").val()
      };
      (0, import_jquery.default)("#app").empty();
      (0, import_jquery.default)("#app").append(login());
      addUsers(usuario);
    });
    (0, import_jquery.default)("#app").on("click", "#btnAgregar", () => {
      (0, import_jquery.default)("#app").empty();
      (0, import_jquery.default)("#app").append(toDoAgregar());
    });
    (0, import_jquery.default)("#app").on("click", "#btnMostrar", () => {
      (0, import_jquery.default)("#app").empty();
      (0, import_jquery.default)("#app").append(toDoMostrar());
      cargarClient();
    });
    (0, import_jquery.default)("#app").on("click", "#btnBack", () => {
      (0, import_jquery.default)("#app").empty();
      (0, import_jquery.default)("#app").append(toDo());
    });
    (0, import_jquery.default)("#app").on("submit", "#formAgregar", (e) => {
      e.preventDefault();
      const client = {
        name: (0, import_jquery.default)("#name").val(),
        lastName: (0, import_jquery.default)("#lastName").val(),
        address: (0, import_jquery.default)("#address").val(),
        phone: (0, import_jquery.default)("#phone").val(),
        id: (0, import_jquery.default)("#id").val()
      };
      addClient(client);
      e.target.reset();
      cargarClient();
    });
    (0, import_jquery.default)("#app").on("submit", "#formSearch", (e) => {
      e.preventDefault();
      const name = (0, import_jquery.default)("#inputSearchPerson").val();
      searchClient(name);
    });
  });
})();
